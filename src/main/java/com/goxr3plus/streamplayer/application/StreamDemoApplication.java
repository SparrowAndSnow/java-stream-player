 ...
 *
 */
public class StreamDemoApplication extends StreamPlayer implements StreamPlayerListener {

    private final String audioAbsolutePath = "C:\\Users\\admin\\Music\\New 24 2025-11-19 2314.mp3";

    /**
     * Constructor
     */
    public StreamDemoApplication() {
        try {
            ...
            // Example
            BufferedInputStream i = new BufferedInputStream(new FileInputStream(new File(audioAbsolutePath)));
            open(i);
