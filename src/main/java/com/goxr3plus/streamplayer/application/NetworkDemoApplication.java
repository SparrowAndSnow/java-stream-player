 ...
 *
 */
public class NetworkDemoApplication extends StreamPlayer implements StreamPlayerListener {

    private final String audioAbsolutePath = "https://p.scdn.co/mp3-preview/049e763cb1a9fe9ef0ecec1a1a27c9335ee521f1?cid=5e72c718428347a2940964e17d3f40ac";

    /**
     * Constructor
     */
    public NetworkDemoApplication() {
        try {
            ...
            // Example
            open(new URI(audioAbsolutePath));
